...
class Sharon extends StatefulWidget {
  @override
  _SharonState createState() => _SharonState();
}

class _SharonState extends State<Sharon> {
  @override
              ...
              child: Column(
                children: <Widget>[
                  FlatButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).pushNamed('/charlotte');
                    },
                  ),
                ],
              ),
